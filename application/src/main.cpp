...
int main(){
    hwlib::wait_ms(3000);
    //pins MAX7219
    auto max_data_in = hwlib::target::pin_out(hwlib::target::pins::d36);
    auto max_cs = hwlib::target::pin_out(hwlib::target::pins::d32);
    auto max_clock = hwlib::target::pin_out(hwlib::target::pins::d50);
    //pins leds
